...
import { BaseCrawler, CrawlOptions, CrawledProduct } from './base';
import { BrowserPool, getGlobalBrowserPool } from './browserPool';
import logger from '../utils/logger';
import type { SourceType } from '../../types/database';

export interface PuppeteerCrawlOptions extends CrawlOptions {
    keyword?: string;
    categorySlug?: string;
    maxPages?: number;
    query?: string;    // Compatibility with BaseCrawler
    category?: string; // Compatibility with BaseCrawler
}
